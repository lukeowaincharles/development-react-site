  ...
  constructor(props) {
    ...
    this.state = {
      ...
      projectContent: [
        ...
        {id: 2, title: 'Teenage Cancer Trust', text: 'I worked with Teenage Cancer Trust to rebuild their donation form in React to tackle the large bounce rate they were facing.', textExtend: '', href: 'https://donate.teenagecancertrust.org/', class: 'tct'},
