  ...
  constructor(props) {
    ...
    this.state = {
      ...
      projectContent: [
        ...
        {id: 3, title: 'Hiscox', text: 'The UK Hiscox site has had a huge overhaul, using Drupal 8. This project will be going live in November.', href: 'https://www.hiscox.co.uk/', class: 'hiscox'},
